		...
		*/
		function before_headers() {
			...
			if( function_exists( 'wp_list_comments' ) && is_singular( ) && $post_type_supports && comments_open( $post->ID ) ) {
				...
				wp_register_script( 'scrollto', SPEC_COMMENT_URL . "/js/jquery.scrollTo-master/jquery.scrollTo.min.js", array( 'jquery' ), '1.4.11', true );
				...
				$localisation = array(
					...
					'scroll_off' => spec_comment_option( 'tc_scroll_offset', 0 )
				);
